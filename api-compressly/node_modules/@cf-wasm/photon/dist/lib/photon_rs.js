...
var Rgba = class {
	...
	*/
	get_blue() {
		return wasm.rgba_get_blue(this.__wbg_ptr);
	}
	/**
	* Get the Green value.
	* @returns {number}
	*/
	get_green() {
		return wasm.rgba_get_green(this.__wbg_ptr);
	}
	/**
	* Get the Red value.
	* @returns {number}
	*/
	get_red() {
		return wasm.rgba_get_red(this.__wbg_ptr);
	}
	/**
...
function __wbg_get_imports() {
	return {
		...
		"./photon_rs_bg.js": {
			...
			__wbg_drawImage_997defe6eb83bb7c: function() {
			...
			__wbg_getImageData_867832cc7a4aac1c: function() {
